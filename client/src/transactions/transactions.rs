use snarkvm::{
    dpc::{address, block::Block, testnet2::Testnet2, Ledger, LedgerProof, VirtualMachine},
    prelude::{Address, PrivateKey, Request, Transaction},
};
...
mod tests {
    ...
    use snarkvm::{
        dpc,
        dpc::{address, block::Block, testnet2::Testnet2, Ledger, LedgerProof, Record},
    ...
    fn create_store_data_request() -> dpc::Request<Testnet2> {
        let mut rng = StdRng::from_entropy();
        let mut rng2 = StdRng::from_entropy();
        let mut rng3 = StdRng::from_entropy();
        let mut rng4 = StdRng::from_entropy();
        ...
        let record_with_data2 = Record::new_input(
            noop_address,
            0,
            payload_data2,
            *<Testnet2>::noop_program_id(),
        ...
        let noop_record1 = Record::new_noop_input(noop_address, &mut rng).unwrap();
